		...
		<div class="col-md-8">
	                        <div class="card">
	                            ...
	                            <div class="card-content">
	                                <form:form action="${s:mvcUrl('DC#gravar').build() }" method="post" modelAttribute="despesa" >
 		                                    <div class="row">
	                                        <div class="col-md-4">
								...
								<form:select path="conta.id" class="selectpicker" data-width="100%">
				                    ...
				                    <i	class="glyphicon glyphicon-plus"></i>
				                    <fmt:message key="despesa.nova.conta" /> 
				                      <div class="ripple-container"></div></a>
											</div>
												<p class="text-danger">
										...
										<div class="col-md-12">
											<div class=togglebutton>
												<label> <form:label path="vaiRepetir" for="vaiRepetir1"
														cssClass="inline">
														<fmt:message key="despesa.cadastro.vaiRepetir" />
						 ...
						 <div class="row">
	                      <div class="col-md-5">
							...
							<form:select path="periodo.periodicidade" class="selectpicker"  >
                                <form:option value="30"><fmt:message key="despesa.cadastro.periodo.mensal" /></form:option>
                                <form:option value="1"><fmt:message key="despesa.cadastro.periodo.diario" /></form:option>
                                <form:option value="7"><fmt:message key="despesa.cadastro.periodo.semanal" /></form:option>
                                <form:option value="365"><fmt:message key="despesa.cadastro.periodo.anual" /></form:option>
                            </form:select>
